                                ...
                                <?php while ($course = $result_courses->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                            <a href="edit_courses_sol.php?id=<?php echo $course['id']; ?>" class="btn-action btn-edit" data-tooltip="Modifier">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <!-- Remplacer le bouton de suppression par un lien direct -->
                                            <a href="manage_courses_sol.php?delete=<?php echo $course['id']; ?>" class="btn-action btn-delete" data-tooltip="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce cours?');">
