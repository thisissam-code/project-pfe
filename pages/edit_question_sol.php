...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: ajouter_question_sol.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_question'])) {
    ...
    if (empty($formation_id) || empty($question_text) || count($answer_texts) != 4 || $correct_answer < 0 || $correct_answer > 3) {
        ...
        if (!$all_answers_filled) {
            ...
            header("Location: ajouter_question_sol.php?updated=1");
            exit();
        }
    }
}
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="ajouter_question_sol.php" class="breadcrumb-link">Gestion des questions</a></li>
            ...
            <div class="card-body">
                <form method="post" action="">
                    ...
                    <div class="form-buttons">
                        ...
                        <a href="ajouter_question_sol.php" class="btn btn-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
