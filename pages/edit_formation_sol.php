...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: manage_formations_sol.php");
    exit();
}
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1 class="page-title">Modifier une Formation <span class="badge bg-primary">SOL</span></h1>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="admin_dashboard_sol.php" class="breadcrumb-link">Accueil</a></li>
                <li class="breadcrumb-item"><a href="manage_formations_sol.php" class="breadcrumb-link">Gestion des formations</a></li>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="manage_formations_sol.php" class="btn btn-secondary">Annuler</a>
