...
// Modification: Compter uniquement les formations de la section "vol"
$query_formations = $conn->query("SELECT COUNT(*) AS total FROM formations WHERE section = 'vol'")->fetch_assoc();

// Modification: Compter uniquement les examens liés aux formations de la section "vol"
...
// Modification: Récupérer uniquement les examens liés aux formations de la section "vol"
...
<head>
    ...
    <title>Tableau de Bord Admin Vol - TTA</title>
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card courses">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-label">Formations Vol</div>
                </div>
            </div>
            <div class="stat-card exams">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-label">Examens Vol</div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Examens récents (Section Vol)</h2>
                <a href="manage_exam_results_vol.php" class="btn btn-sm btn-outline-primary">Voir tous</a>
            </div>
            <div class="card-body">
        ...
        <div class="stats-grid">
            ...
            <div class="card animate-on-scroll">
                <div class="card-header">
                    <h2 class="card-title">Progression des formations</h2>
                </div>
                <div class="card-body">
                    <div class="chart-container">
            ...
            <div class="card-body">
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        ...
                        <p><strong>Rôle:</strong> Administrateur Vol</p>
