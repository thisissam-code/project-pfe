                                    ...
                                    <?php while ($formation = $result_formations->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="table-actions">
                                                <a href="view_formations.php?id=<?php echo $formation['id']; ?>" class="btn-action btn-view" data-tooltip="Voir">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="manage_formations.php?edit=<?php echo $formation['id']; ?>" class="btn-action btn-edit" data-tooltip="Modifier">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <!-- Remplacer le bouton de suppression par un lien direct -->
                                                <a href="manage_formations.php?delete=<?php echo $formation['id']; ?>" class="btn-action btn-delete" data-tooltip="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette formation?');">
