...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_formation'])) {
    ...
    $section = 'sol'; // Forcer la section à 'sol'
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    // Vérifier que la formation est de type 'sol'
    $check_query = "SELECT id FROM formations WHERE id = ? AND section = 'sol'";
    $stmt = $conn->prepare($check_query);
    ...
    if ($check_result->num_rows === 0) {
        $error_message = "Cette formation n'est pas de type 'sol' ou n'existe pas.";
    } else {
        ...
        if ($stmt->execute()) {
            header("Location: manage_formations.php?deleted=1");
            exit();
        } else {
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
    ...
    $query = "SELECT * FROM formations WHERE id = ? AND section = 'sol'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_formation'])) {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: manage_formations.php?updated=1");
            exit();
        } else {
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1 class="page-title">Gestion des Formations <span class="badge bg-primary">SOL</span></h1>
            <ul class="breadcrumb">
            ...
            <div class="card animate-on-scroll">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <input type="hidden" name="section" value="sol">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="section_display" class="form-control" value="Sol" readonly>
                            </div>
                                    ...
                                    <?php while ($formation = $result_formations->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="table-actions">
                                                <a href="view_formations_sol.php?id=<?php echo $formation['id']; ?>" class="btn-action btn-view" data-tooltip="Voir">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="edit_formation_sol.php?id=<?php echo $formation['id']; ?>" class="btn-action btn-edit" data-tooltip="Modifier">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <!-- Remplacer le bouton de suppression par un lien direct -->
                                                <a href="manage_formations_sol.php?delete=<?php echo $formation['id']; ?>" class="btn-action btn-delete" data-tooltip="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette formation?');">
