...
if ($selected_result > 0) {
    ...
    if ($result_exam_details && $result_exam_details->num_rows > 0) {
        ...
        header("Location: manage_exam_results_sol.php" . ($selected_pilot > 0 ? "?pilot_id=" . $selected_pilot : ""));
        exit();
    }
}
...
function buildUrl($params = []) {
    ...
    $url = 'manage_exam_results_sol.php';
    if (!empty($url_params)) {
    ...
    <div class="main-content">
        ...
        <div class="filter-section">
            ...
            <?php if ($selected_pilot > 0 || (!$fixed_section && $selected_section !== '') || $selected_formation > 0): ?>
                <div class="filter-item">
                    <a href="<?php echo $fixed_section ? 'manage_exam_results_sol.php' : 'manage_exam_results_sol.php'; ?>" class="btn btn-secondary">
