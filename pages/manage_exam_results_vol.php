...
if ($selected_result > 0) {
    ...
    if ($result_exam_details && $result_exam_details->num_rows > 0) {
        ...
        header("Location: manage_exam_results_vol.php" . ($selected_pilot > 0 ? "?pilot_id=" . $selected_pilot : ""));
        exit();
    }
}
...
function buildUrl($params = []) {
    ...
    $url = 'manage_exam_results_vol.php';
    if (!empty($url_params)) {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="filter-section">
            ...
            <?php if ($selected_pilot > 0 || (!$fixed_section && $selected_section !== '') || $selected_formation > 0): ?>
                <div class="filter-item">
                    <a href="<?php echo $fixed_section ? 'manage_exam_results_vol.php' : 'manage_exam_results_vol.php'; ?>" class="btn btn-secondary">
    ...
    <script>
        function applyFilters() {
            ...
            let url = 'manage_exam_results_vol.php';
            let params = [];
