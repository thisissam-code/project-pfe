...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: manage_courses_vol.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_course'])) {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if (!isset($error_message)) {
            ...
            if ($stmt->execute()) {
                header("Location: manage_courses_vol.php?updated=1");
                exit();
            } else {
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="manage_courses_vol.php" class="breadcrumb-link">Gestion des cours</a></li>
            ...
            <div class="card-body">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="manage_courses_vol.php" class="btn btn-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
