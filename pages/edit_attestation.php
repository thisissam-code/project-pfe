   ...
   <div class="main-content">
       <div class="page-header">
           ...
           <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item"><a href="manage_attestations.php" class="breadcrumb-link">Gestion des attestations</a></li>
           ...
           <div class="card-body">
               <form method="POST" action="" enctype="multipart/form-data">
                   ...
                   <div class="d-flex justify-content-between">
                       <a href="manage_attestations.php" class="btn btn-secondary">Annuler</a>
