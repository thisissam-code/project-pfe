...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item">
            <a href="manage_users.php" class="sidebar-link <?php echo ($current_page == 'manage_users.php' || $current_page == 'add_user.php' || $current_page == 'edit_user.php' || $current_page == 'view_user.php') ? 'active' : ''; ?>">
                <i class="fas fa-users sidebar-icon"></i>
                <span class="sidebar-text">Gestion des utilisateurs</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a href="manage_courses.php" class="sidebar-link <?php echo ($current_page == 'manage_courses.php' || $current_page == 'edit_course.php') ? 'active' : ''; ?>">
        ...
        <li class="sidebar-item">
            <a href="manage_formations.php" class="sidebar-link <?php echo ($current_page == 'manage_formations.php') ? 'active' : ''; ?>">
                <i class="fas fa-graduation-cap sidebar-icon"></i>
                <span class="sidebar-text">Gestion des formations</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a href="library.php" class="sidebar-link <?php echo ($current_page == 'pilot_library.php') ? 'active' : ''; ?>">
                <i class="fas fa-book-reader sidebar-icon"></i>
                <span class="sidebar-text">Gestion de Bibliothèque</span>
            </a>
        </li>
        <li class="sidebar-item">
        ...
        <li class="sidebar-item">
            <a href="ajouter_question.php" class="sidebar-link <?php echo ($current_page == 'ajouter_question.php' ) ? 'active' : ''; ?>">
                <i class="fas fa-users sidebar-icon"></i>
                <span class="sidebar-text">Gestion des question</span>
            </a>
        </li>    
        <li class="sidebar-item">
            <a href="manage_exam_results.php" class="sidebar-link <?php echo ($current_page == 'manage_exam_results.php') ? 'active' : ''; ?>">
                <i class="fas fa-cog sidebar-icon"></i>
        ...
        <li class="sidebar-item">
            <a href="manage_attestations.php" class="sidebar-link <?php echo ($current_page == 'manage_attestations.php' ) ? 'active' : ''; ?>">
                <i class="fas fa-users sidebar-icon"></i>
